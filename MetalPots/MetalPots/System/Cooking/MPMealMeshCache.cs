    ...
    internal class MPMealMeshCache : ModSystem, ITexPositionSource
    {
        ...
        public MeshData GetPieMesh(ItemStack pieStack, ModelTransform transform = null)
        {
            ...
            if (ContentsRotten(contentStacks))
            {
                ...
                fillingTextureLoc = new AssetLocation("game:block/rot/rot");
                topCrustTextureLoc = new AssetLocation("game:block/rot/rot");
            }
            else
            {
            ...
            shapeloc.WithPathAppendixOnce(".json").WithPathPrefixOnce("game:shapes/");
        ...
        public AssetLocation[] pieMixedFillingTextures = new AssetLocation[] {
            new AssetLocation("game:block/food/pie/fill-mixedfruit"),
            new AssetLocation("game:block/food/pie/fill-mixedvegetable"),
            new AssetLocation("game:block/food/pie/fill-mixedmeat"),
            new AssetLocation("game:grain-unused-placeholder"),
            new AssetLocation("game:block/food/pie/fill-mixedcheese")
        };
